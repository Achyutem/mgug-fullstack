...
// Import Select component for mobile
import {
  Select,
  SelectContent,
  SelectItem,
...
const PhDPrograms = () => {
  ...
  const dynamicContent = phdprogramsContent;
  const staticText = phdProgramsStaticText; // Use the static text object
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <main className="md:col-span-9 lg:col-span-9">
              ...
              <div className="md:hidden mb-6">
                ...
                >
                  <SelectTrigger className="w-full bg-orange-500/10 border-gray-700/80 focus:ring-orange-500">
...
const ProgramCard = ({ program, language, staticText }: any) => {
  return (
    <Dialog>
      <div className="h-full flex flex-col justify-between p-6 rounded-xl bg-orange-500/10 backdrop-blur-sm border hover:border-2 border-gray-700/80 hover:bg-transparent shadow-lg hover:border-orange-600 transition-colors duration-300">
        <div>
