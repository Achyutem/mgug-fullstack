...
export default function SearchDialog({
  ...
  // --- Keyboard shortcuts (Up, Down, Enter, Escape) ---
  useEffect(() => {
  ...
  }, [open, results, highlightedIndex, navigate, setOpen]);
            ...
            results.map((item, index) => {
              ...
              return isExternal ? (
                <a
                  ...
                  className={`block p-3 rounded-lg transition-all ${index === highlightedIndex
