...
const NewCard = ({ icon, title, href }: NewCardProps) => {
  ...
  const className =
    "group relative bg-orange-500/10 backdrop-blur-lg border border-orange-600 rounded-2xl p-6 text-center shadow-sm transition-all duration-300 ease-in-out hover:shadow-orange-500/20 hover:scale-105 hover:border-orange-500 hover:-translate-y-2 flex flex-col items-center justify-center";
